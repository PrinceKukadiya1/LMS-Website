        ...
        <TableBody>
          {course?.map((course) => (
            <TableRow key={course._id}>
              <TableCell className="md:w-[300px] flex min-w-full items-center gap-2"><img src={course?.courseThumbnail} alt="Thumbnail" className='w-20 hidden md:block rounded-sm' />
                {course.courseTitle}
              </TableCell>
