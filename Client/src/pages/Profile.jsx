...
const Profile = () => {
    ...
    return (
        <div className='bg-gray-100 py-12 px-4 min-h-screen'>
            <div className='max-w-6xl mx-auto p-8 bg-gradient-to-r bg-white shadow-xl rounded-2xl mt-20'>
            ...
            {/* profile picture */}
                    ...
                    <div className='text-center md:text-left'>
                        ...
                        <p className='my-1 text-gray-600 capitalize '><span className='font-bold'>Role :</span> {user?.role}</p>
                        <p className='text-gray-700 text-base leading-relaxed mb-3'>
                            <span className='font-bold'>Bio :</span> {user?.description || "Add Your Bio."}
                        </p>
                        <Dialog open={open} onOpenChange={setOpen}>
                            <Button onClick={() => setOpen(true)} className="bg-blue-500 text-white hover:bg-blue-600" >Edit Profile</Button>

                            <DialogContent className="bg-white z-50 shadow-xl border-none sm:max-w-[425px]">
                                <DialogHeader>
                                ...
                                <DialogFooter>
                                    {
                                        loading ? <Button className='bg-blue-400'><Loader2 className='mr-2 w-4 h-4 animate-spin'></Loader2>Please Wait</Button> : <Button onClick={submitHandler} className="bg-blue-500 text-white hover:bg-blue-600" >Save Changes</Button>
                                    }
                                </DialogFooter>
                            </DialogContent>
                        </Dialog>
